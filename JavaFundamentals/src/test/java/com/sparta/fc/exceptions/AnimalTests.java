...
public class AnimalTests {
    ...
    @Test
    @DisplayName("given a date in dd-MM-yyyy format, setVaccinationDate() sets the date")
    public void setVaccinationDateHappyPath() throws ParseException {
        Animal sut = new Animal("Buddy", 3);
        sut.setVaccinationDate("15-08-2022"); // takes a string, and saves a SimpleDateFormat object

        // turning the newDate date object into a string again so it can be compared to the string passed in CsvSource as the expected value
        String newDateConverted = new java.text.SimpleDateFormat("dd-MM-yyyy").format(sut.getVaccinationDate());

        Assertions.assertEquals("15-08-2022", newDateConverted);
    }
