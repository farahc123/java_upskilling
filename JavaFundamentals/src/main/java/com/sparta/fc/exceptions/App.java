...
//        System.out.println("Program is finished");
        ...
        try{
            ...
            Animal myRabbit = new Animal(null, 1, "27-07-2022"); // set name to null to throw NullPointer exception
            Animal myOtherDog = new Animal("Dayanna", 2, "27-07-2022"); //  set age to -2 to throw IllegalArgument exception
            Animal myOtherCat = new Animal("Farah", 12, "27 July, 2022"); // set age to "27 July, 2022" to throw Parse exception
